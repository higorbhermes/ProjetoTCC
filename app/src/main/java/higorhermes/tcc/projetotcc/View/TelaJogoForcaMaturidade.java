...
public class TelaJogoForcaMaturidade extends AppCompatActivity {
    int pontos;
    int erro = 0;
    int acertos = 0;
    ...
    String letracerta5 = "R";
    String letracerta6 = "I";
    String letracerta7 = "D";
    ...
    String letracerta24 = "";
    String letracerta25 = "";
    String dica = "Grau para o qual um sistema, produto ou componente atende às necessidades de confiabilidade sob operação normal.";
    JogoForca[] partidas;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tela_jogo_forca_maturidade);
        ...
        button_revelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pontos < 60) {
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(    TelaJogoForcaMaturidade.this);
                    dlg.setMessage(msg);
        ...
        button_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(  TelaJogoForcaMaturidade.this, button_menu);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (s.equals("Caderno")) {
                            Intent intent = new Intent(  TelaJogoForcaMaturidade.this, TelaCadernoCaracteristicasQualidade.class);
                            startActivity(intent);
                        }
                        if (s.equals("Desempenho")) {
                            Intent intent = new Intent(  TelaJogoForcaMaturidade.this, TelaDesempenho.class);
                            startActivity(intent);
                        }
                        if (s.equals("Ajustes")) {
                            Intent intent = new Intent(  TelaJogoForcaMaturidade.this, TelaAjustes.class);
                            startActivity(intent);
                        }
                        if (s.equals("Avaliar")) {
                            Intent intent = new Intent(  TelaJogoForcaMaturidade.this, TelaAvaliacao.class);
                            startActivity(intent);
                        }
                        return true;
                    }
    ...
    public void NovaTela(){
        if (partidas[contador_partidas+1] == null){
            Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaFimDeJogo.class);
            startActivity(intent);
        }
        else{
            if (filtro == 1 ||  filtro == 2){
                if (partidas[contador_partidas+1].getId() == 201){
                    ...
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForca.class);
                ...
                if (partidas[contador_partidas+1].getId() == 202){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAcessibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 203){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAdaptabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 204){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAdequabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 205){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAdequacaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 206){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAnalisabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 207){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAprendizagem.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 208){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaAutenticidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 209){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaCapacidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 210){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaCoexistencia.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 211){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaCompatibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 212){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaCompletudeFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 213){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaComportamentoNoTempo.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 214){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaConfiabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 215){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaCorrecaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 216){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaDisponibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 217){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaEficienciaDeDesempenho.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 218){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaEsteticaDaInterface.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 219){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaInstalabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 220){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaIntegridade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 221){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaManutencao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 222){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaMaturidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 223){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaModificabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 224){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaModularidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 225){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaNaoRepudio.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 226){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaOperabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 227){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaPortabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 228){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaPrestacaoDeContas.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 229){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaProtecaoContraErros.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 30){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaReplacibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 31){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaReutilizacao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 32){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaTestabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 33){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaUsabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 34){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaMaturidade.this, TelaJogoForcaUtilizacaoDeRecursos.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
    ...
    public void finish(){
        AlertDialog.Builder alerta = new AlertDialog.Builder(  TelaJogoForcaMaturidade.this);
        ...
        alerta.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(  TelaJogoForcaMaturidade.this, TelaMenu.class);
                startActivity(intent);
            }
        });
        alerta.show();
