...
public class  TelaJogoForcaAcessibilidade extends AppCompatActivity {
    int pontos;
    int erro = 0;
    int acertos = 0;
    ...
    String letracerta2 = "C";
    String letracerta3 = "E";
    String letracerta4 = "S";
    String letracerta5 = "S";
    ...
    String letracerta24 = "";
    String letracerta25 = "";
    String dica = "Grau para o qual um produto ou sistema pode ser usado por pessoas com a mais ampla gama de características e capacidades para atingir um objetivo especificado em um contexto especificado de uso.";
    JogoForca[] partidas;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tela_jogo_forca_acessibilidade);
        ...
        button_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(  TelaJogoForcaAcessibilidade.this, button_menu);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (s.equals("Caderno")) {
                            Intent intent = new Intent(  TelaJogoForcaAcessibilidade.this, TelaCadernoCaracteristicasQualidade.class);
                            startActivity(intent);
                        }
                        if (s.equals("Desempenho")) {
                            Intent intent = new Intent(  TelaJogoForcaAcessibilidade.this, TelaDesempenho.class);
                            startActivity(intent);
                        }
                        if (s.equals("Ajustes")) {
                            Intent intent = new Intent(  TelaJogoForcaAcessibilidade.this, TelaAjustes.class);
                            startActivity(intent);
                        }
                        if (s.equals("Avaliar")) {
                            Intent intent = new Intent(  TelaJogoForcaAcessibilidade.this, TelaAvaliacao.class);
                            startActivity(intent);
                        }
                        return true;
                    }
    ...
    public void NovaTela(){
        if (partidas[contador_partidas+1] == null){
            Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaFimDeJogo.class);
            startActivity(intent);
        }
        else{
            if (filtro == 1 ||  filtro == 2){
                if (partidas[contador_partidas+1].getId() == 201){
                    ...
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForca.class);
                ...
                if (partidas[contador_partidas+1].getId() == 202){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAcessibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 203){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAdaptabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 204){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAdequabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 205){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAdequacaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 206){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAnalisabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 207){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAprendizagem.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 208){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaAutenticidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 209){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaCapacidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 210){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaCoexistencia.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 211){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaCompatibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 212){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaCompletudeFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 213){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaComportamentoNoTempo.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 214){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaConfiabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 215){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaCorrecaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 216){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaDisponibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 217){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaEficienciaDeDesempenho.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 218){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaEsteticaDaInterface.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 219){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaInstalabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 220){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaIntegridade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 221){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaManutencao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 222){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaMaturidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 223){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaModificabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 224){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaModularidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 225){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaNaoRepudio.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 226){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaOperabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 227){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaPortabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 228){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaPrestacaoDeContas.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 229){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaProtecaoContraErros.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 30){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaReplacibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 31){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaReutilizacao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 32){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaTestabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 33){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaUsabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 34){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaAcessibilidade.this, TelaJogoForcaUtilizacaoDeRecursos.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
    ...
    public void finish(){
        AlertDialog.Builder alerta = new AlertDialog.Builder(  TelaJogoForcaAcessibilidade.this);
        ...
        alerta.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(  TelaJogoForcaAcessibilidade.this, TelaMenu.class);
                startActivity(intent);
            }
        });
        alerta.show();
