...
public class TelaJogoForcaInstalabilidade extends AppCompatActivity {
    int pontos;
    int erro = 0;
    int acertos = 0;
    ...
    int id;
    String letracerta1 = "I";
    String letracerta2 = "N";
    String letracerta3 = "S";
    String letracerta4 = "T";
    String letracerta5 = "A";
    String letracerta6 = "L";
    ...
    String letracerta24 = "";
    String letracerta25 = "";
    String dica = "Grau de eficácia e eficiência com o qual um produto ou sistema pode ser instalado e / ou desinstalado com êxito em um ambiente especificado.";
    JogoForca[] partidas;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tela_jogo_forca_instalabilidade);
        ...
        button_revelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pontos < 60) {
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(    TelaJogoForcaInstalabilidade.this);
                    dlg.setMessage(msg);
        ...
        button_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(  TelaJogoForcaInstalabilidade.this, button_menu);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (s.equals("Caderno")) {
                            Intent intent = new Intent(  TelaJogoForcaInstalabilidade.this, TelaCadernoCaracteristicasQualidade.class);
                            startActivity(intent);
                        }
                        if (s.equals("Desempenho")) {
                            Intent intent = new Intent(  TelaJogoForcaInstalabilidade.this, TelaDesempenho.class);
                            startActivity(intent);
                        }
                        if (s.equals("Ajustes")) {
                            Intent intent = new Intent(  TelaJogoForcaInstalabilidade.this, TelaAjustes.class);
                            startActivity(intent);
                        }
                        if (s.equals("Avaliar")) {
                            Intent intent = new Intent(  TelaJogoForcaInstalabilidade.this, TelaAvaliacao.class);
                            startActivity(intent);
                        }
                        return true;
                    }
    ...
    public void NovaTela(){
        if (partidas[contador_partidas+1] == null){
            Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaFimDeJogo.class);
            startActivity(intent);
        }
        else{
            if (filtro == 1 ||  filtro == 2){
                if (partidas[contador_partidas+1].getId() == 201){
                    ...
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForca.class);
                ...
                if (partidas[contador_partidas+1].getId() == 202){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAcessibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 203){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAdaptabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 204){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAdequabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 205){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAdequacaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 206){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAnalisabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 207){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAprendizagem.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 208){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaAutenticidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 209){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaCapacidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 210){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaCoexistencia.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 211){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaCompatibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 212){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaCompletudeFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 213){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaComportamentoNoTempo.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 214){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaConfiabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 215){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaCorrecaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 216){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaDisponibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 217){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaEficienciaDeDesempenho.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 218){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaEsteticaDaInterface.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 219){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaInstalabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 220){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaIntegridade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 221){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaManutencao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 222){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaMaturidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 223){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaModificabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 224){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaModularidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 225){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaNaoRepudio.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 226){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaOperabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 227){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaPortabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 228){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaPrestacaoDeContas.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 229){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaProtecaoContraErros.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 30){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaReplacibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 31){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaReutilizacao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 32){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaTestabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 33){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaUsabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 34){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaInstalabilidade.this, TelaJogoForcaUtilizacaoDeRecursos.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
    ...
    public void finish(){
        AlertDialog.Builder alerta = new AlertDialog.Builder(  TelaJogoForcaInstalabilidade.this);
        ...
        alerta.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(  TelaJogoForcaInstalabilidade.this, TelaMenu.class);
                startActivity(intent);
            }
        });
        alerta.show();
