...
public class TelaJogoForcaIntegridade extends AppCompatActivity {
    int pontos;
    int erro = 0;
    int acertos = 0;
    int numero_letras = 11;
    ...
    String letracerta5 = "G";
    String letracerta6 = "R";
    String letracerta7 = "I";
    String letracerta8 = "D";
    ...
    String letracerta24 = "";
    String letracerta25 = "";
    String dica = "Grau para o qual um sistema, produto ou componente impede o acesso não autorizado ou a modificação de programas de computador ou dados.";
    JogoForca[] partidas;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tela_jogo_forca_integridade);
        ...
        button_revelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pontos < 60) {
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(    TelaJogoForcaIntegridade.this);
                    dlg.setMessage(msg);
        ...
        button_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(  TelaJogoForcaIntegridade.this, button_menu);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (s.equals("Caderno")) {
                            Intent intent = new Intent(  TelaJogoForcaIntegridade.this, TelaCadernoCaracteristicasQualidade.class);
                            startActivity(intent);
                        }
                        if (s.equals("Desempenho")) {
                            Intent intent = new Intent(  TelaJogoForcaIntegridade.this, TelaDesempenho.class);
                            startActivity(intent);
                        }
                        if (s.equals("Ajustes")) {
                            Intent intent = new Intent(  TelaJogoForcaIntegridade.this, TelaAjustes.class);
                            startActivity(intent);
                        }
                        if (s.equals("Avaliar")) {
                            Intent intent = new Intent(  TelaJogoForcaIntegridade.this, TelaAvaliacao.class);
                            startActivity(intent);
                        }
                        return true;
                    }
    ...
    public void NovaTela(){
        if (partidas[contador_partidas+1] == null){
            Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaFimDeJogo.class);
            startActivity(intent);
        }
        else{
            if (filtro == 1 ||  filtro == 2){
                if (partidas[contador_partidas+1].getId() == 201){
                    ...
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForca.class);
                ...
                if (partidas[contador_partidas+1].getId() == 202){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAcessibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 203){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAdaptabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 204){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAdequabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 205){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAdequacaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 206){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAnalisabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 207){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAprendizagem.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 208){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaAutenticidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 209){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaCapacidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 210){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaCoexistencia.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 211){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaCompatibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 212){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaCompletudeFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 213){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaComportamentoNoTempo.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 214){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaConfiabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 215){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaCorrecaoFuncional.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 216){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaDisponibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 217){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaEficienciaDeDesempenho.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 218){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaEsteticaDaInterface.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 219){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaInstalabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 220){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaIntegridade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 221){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaManutencao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 222){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaMaturidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 223){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaModificabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 224){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaModularidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 225){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaNaoRepudio.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 226){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaOperabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 227){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaPortabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 228){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaPrestacaoDeContas.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 229){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaProtecaoContraErros.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 30){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaReplacibilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 31){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaReutilizacao.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 32){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaTestabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 33){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaUsabilidade.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                if (partidas[contador_partidas+1].getId() == 34){
                    ...
                    bundle.putInt("partidas_atuais", 1);
                    bundle.putInt("contador_partidas", contador_partidas+1);
                    Intent intent = new Intent(TelaJogoForcaIntegridade.this, TelaJogoForcaUtilizacaoDeRecursos.class);
                    intent.putExtra("partidas", partidas);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
    ...
    public void finish(){
        AlertDialog.Builder alerta = new AlertDialog.Builder(  TelaJogoForcaIntegridade.this);
        ...
        alerta.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(  TelaJogoForcaIntegridade.this, TelaMenu.class);
                startActivity(intent);
            }
        });
        alerta.show();
